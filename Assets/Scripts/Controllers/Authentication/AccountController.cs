...
public class AccountController : MonoBehaviour
{
    ...
    /// </summary>
    private void DisplayUsersInScrollView(IList<Player> players, GameObject prefab, string buttonName, Action<Guid?> buttonFunction) {
    ...
    public async void ChallengeUser(Guid? userID) {
        Debug.LogError("Challenging Player not implemented");
    }

    public async void AddFriend(Guid? userID) {
    ...
    public async void DeleteFriend(Guid? userID) {
